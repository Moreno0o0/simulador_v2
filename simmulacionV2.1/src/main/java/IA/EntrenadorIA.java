...
public class EntrenadorIA {
    ...
    public static void entrenar(EntornoPista entorno, String nombreHilo) {
        ...
        QLearningConfiguration configQL = QLearningConfiguration.builder()
                .seed(123L)
                .maxEpochStep(20000)        // Si da 2000 pasos sin meta/choque, reiniciamos (evita bucles infinitos)
                .maxStep(250000)           // ¡MEDIO MILLÓN de pasos de entrenamiento total!
                .expRepMaxSize(5000)      // Memoria de elefante: recuerda sus últimos 50,000 pasos
                .batchSize(64)             // Lotes más pequeños para redes pequeñas (aprende más rápido)
                .targetDqnUpdateFreq(500)  // Frecuencia de actualización de la red objetivo
                .updateStart(1000)         // Espera a tener 1000 recuerdos antes de empezar a estudiar
                ...
                .epsilonNbStep(10000)     // Explora (hace locuras) durante los primeros 100k pasos
                .doubleDQN(true)
                .build();
        ...
        DQNDenseNetworkConfiguration configRed = DQNDenseNetworkConfiguration.builder()
                ...
                .numLayers(3)              // Reducido de 6 a 3 capas (Perfecto para 5 sensores)
                .build();
