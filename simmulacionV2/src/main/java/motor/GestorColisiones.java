...
public class GestorColisiones {
    ...
    public boolean chocaConBorde(Vehiculo vehiculo) {
        ...
        // 1. Calculamos la trompa del carro usando las medidas reales del Vehiculo
        ...
        // 2. Verificamos si la trompa sale de la imagen
        if (trompaX < 0 || trompaX >= mascara_img.getWidth() ||
                trompaY < 0 || trompaY >= mascara_img.getHeight()) {
            return true;
        }

        // 3. Leemos el color y determinamos el choque
